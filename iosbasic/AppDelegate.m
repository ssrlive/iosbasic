...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions {
    NSLocalizedString(@"This app need to access your camera", nil);
    NSLocalizedString(@"This app need to access your photos", nil);
    ...
    UINavigationController* nc = [[UINavigationController alloc] initWithRootViewController:mainCtrl];
